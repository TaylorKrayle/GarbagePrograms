...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	pos[0] << width / 2, -height, 0;
	pos[1] << width / 2, height, 0;
	pos[2] << -width / 2, -height, 0;
	pos[3] << -width / 2, height, 0;

	CUSTOMVERTEX v[4] =
	{
		{ pos[0].x(), pos[0].y(), 0.0f, 1.0f, 0x00000000, 0.0f, 0.0f },
		{ pos[1].x(), pos[1].y(), 0.0f, 1.0f, 0x000000ff, 0.0f, 1.0f },
		{ pos[2].x(), pos[2].y(), 0.0f, 1.0f, 0x00000300, 1.0f, 0.0f },
		{ pos[3].x(), pos[3].y(), 0.0f, 1.0f, 0x00000400, 1.0f, 1.0f }
	};
